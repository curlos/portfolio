  ...
  return [
    {
      ...
      summary: 'A sneaker e-commerce site where users can add shoes to their shopping cart and checkout.',
    ...
    },
    {
      ...
      summary: 'Clone of Netflix that uses the TMDB API to showcase movies and watch previews of thousands of movies.',
    ...
    },
    {
      ...
      description: '',
      summary: 'Clone of Twitter where users can authorize their accounts to create, read, update, delete, like and retweet tweets.',
